      ...
      <div className="min-h-half">
        ...
        <div className="pl-3 pr-3 mt-4">
          ...
          >
            ...
            <h2 className="mt-1  h-7">
              Your Timezone(Asia/calcutta){" "}
              <span style={{ color: Colors.dark_blue }}>Updated</span>
            </h2>
            <hr />
            <div className="flex flex-row  overflow-x-scroll  whitespace-nowrap font-primayfont text-base mt-6">
              <div className="slider flex flex-row mb-6">
                ...
                <div
                  className="ml-4 w-20 h-20 mt-4 text-center pt-2 rounded-lg"
                  style={{
                    borderWidth: 1,
                    borderColor: Colors.textInputBorder,
                  }}
                ...
                <div
                  className="ml-4 w-20 h-20 pl-4 mt-4 text-center pt-2 rounded-lg"
                  style={{
                    borderWidth: 1,
                    borderColor: Colors.textInputBorder,
                  }}

...
const UserAvtar = ({ user }) => {
    ...
    const navigateToManage = () => {
        ...
        navigate(`/${userType}/dashboard/manageprofile`);
    };
    ...
    return (
        <>
            ...
            {isMenuOpen && <div className="absolute mt-44 rounded-lg -ml-32 w-48 bg-white cursor-pointer" style={{ boxShadow: '0px 0px 8px rgba(0, 16, 60, 0.1)' }}>
                ...
                <li onClick={navigateToManage} className="list-none px-4 py-1 text-dark-blue capitalize font-primayfont hover:bg-primar-second hover:text-white ">Manage</li>
